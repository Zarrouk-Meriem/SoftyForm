...
type HasRequiredProps<T, True, False> =
 ...
 * @public
 */
type BaseQueryResult<BaseQuery extends BaseQueryFn> =
 ...
 * @public
 */
type BaseQueryMeta<BaseQuery extends BaseQueryFn> = UnwrapPromise<
	ReturnType<BaseQuery>
>["meta"];
/**
 * @public
 */
type BaseQueryError<BaseQuery extends BaseQueryFn> = Exclude<
 ...
 * @public
 */
type BaseQueryArg<T extends (arg: any, ...args: any[]) => any> = T extends (
	arg: infer A,
	...args: any[]
) => any
	? A
 ...
 */
declare function buildCreateApi<
	Modules extends [Module<any>, ...Module<any>[]],
...
type BuildSelectorsApiEndpointQuery<
...
type BuildSelectorsApiEndpointInfiniteQuery<
...
type BuildSelectorsApiEndpointMutation<
...
type BuildThunksApiEndpointQuery<
	Definition extends QueryDefinition<any, any, any, any, any>,
> = Matchers<QueryThunk, Definition>;
type BuildThunksApiEndpointInfiniteQuery<
	Definition extends InfiniteQueryDefinition<any, any, any, any, any>,
> = Matchers<QueryThunk, Definition>;
type BuildThunksApiEndpointMutation<
	Definition extends MutationDefinition<any, any, any, any, any>,
...
type QueryThunkArg = QuerySubstateIdentifier &
	StartQueryActionCreatorOptions & {
		type: "query";
		originalArgs: unknown;
		endpointName: string;
	};
type InfiniteQueryThunkArg<
...
type BuildInitiateApiEndpointQuery<
	Definition extends QueryDefinition<any, any, any, any, any>,
> = {
	initiate: StartQueryActionCreator<Definition>;
};
type BuildInitiateApiEndpointInfiniteQuery<
	Definition extends InfiniteQueryDefinition<any, any, any, any, any>,
> = {
	initiate: StartInfiniteQueryActionCreator<Definition>;
};
type BuildInitiateApiEndpointMutation<
	Definition extends MutationDefinition<any, any, any, any, any>,
> = {
...
type StartInfiniteQueryActionCreatorOptions<
	D extends InfiniteQueryDefinition<any, any, any, any, any>,
> = StartQueryActionCreatorOptions & {
	direction?: InfiniteQueryDirection;
	param?: unknown;
...
interface QueryBaseLifecycleApi<
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ResultType,
...
> = MutationBaseLifecycleApi<QueryArg, BaseQuery, ResultType, ReducerPath> &
	CacheLifecyclePromises<ResultType, BaseQueryMeta<BaseQuery>>;
type CacheLifecycleQueryExtraOptions<
	ResultType,
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ReducerPath extends string = string,
...
type CacheLifecycleInfiniteQueryExtraOptions<
	ResultType,
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ReducerPath extends string = string,
> = CacheLifecycleQueryExtraOptions<
	...
	ReducerPath
>;
type CacheLifecycleMutationExtraOptions<
	ResultType,
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ReducerPath extends string = string,
...
type QueryLifecycleQueryExtraOptions<
	ResultType,
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ReducerPath extends string = string,
...
type QueryLifecycleInfiniteQueryExtraOptions<
	ResultType,
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ReducerPath extends string = string,
> = QueryLifecycleQueryExtraOptions<
	...
	ReducerPath
>;
type QueryLifecycleMutationExtraOptions<
	ResultType,
	QueryArg,
	BaseQuery extends BaseQueryFn,
	ReducerPath extends string = string,
 ...
 * @public
 */
type TypedMutationOnQueryStarted<
	ResultType,
	QueryArgumentType,
	BaseQueryFunctionType extends BaseQueryFn,
	ReducerPath extends string = string,
 ...
 */
type UpsertEntries<Definitions extends EndpointDefinitions> = (<
...
declare function buildSlice({
	...
	actions: {
		...
		updateProvidedBy: _reduxjs_toolkit.ActionCreatorWithPreparedPayload<
			[
				payload: {
			...
			`${string}/invalidation/updateProvidedBy`,
			never,
			unknown
		>;
		removeMutationResult: _reduxjs_toolkit.ActionCreatorWithPreparedPayload<
			[payload: MutationSubstateIdentifier],
			MutationSubstateIdentifier,
			`${string}/mutations/removeMutationResult`,
			never,
			unknown
		>;
		subscriptionsUpdated: _reduxjs_toolkit.ActionCreatorWithPreparedPayload<
			[payload: Patch[]],
			Patch[],
			`${string}/internalSubscriptions/subscriptionsUpdated`,
			never,
			unknown
		>;
		...
		removeQueryResult: _reduxjs_toolkit.ActionCreatorWithPreparedPayload<
			[payload: QuerySubstateIdentifier],
			QuerySubstateIdentifier,
			`${string}/queries/removeQueryResult`,
			never,
			unknown
		>;
		cacheEntriesUpserted: _reduxjs_toolkit.ActionCreatorWithPreparedPayload<
			[payload: NormalizedQueryUpsertEntryPayload[]],
			ProcessedQueryUpsertEntry[],
			`${string}/queries/cacheEntriesUpserted`,
			never,
			{
		...
		>;
		queryResultPatched: _reduxjs_toolkit.ActionCreatorWithPreparedPayload<
			[
				payload: QuerySubstateIdentifier & {
					patches: readonly Patch[];
				},
			...
			unknown
		>;
		middlewareRegistered: _reduxjs_toolkit.ActionCreatorWithPayload<
			string,
			`${string}/config/middlewareRegistered`
		>;
	};
};
 ...
 */
declare function setupListeners(
	dispatch: ThunkDispatch<any, any, any>,
	customHandler?: (
		dispatch: ThunkDispatch<any, any, any>,
		actions: {
...
interface ApiEndpointInfiniteQuery<
	Definition extends InfiniteQueryDefinition<any, any, any, any, any>,
	Definitions extends EndpointDefinitions,
 ...
 */
declare function fakeBaseQuery<ErrorType>(): BaseQueryFn<
	void,
	NEVER,
	ErrorType,
	{}
...
type InfiniteQueryArgFrom<D extends BaseEndpointDefinition<any, any, any>> =
...
type ReducerPathFrom<D extends EndpointDefinition<any, any, any, any, any>> =
	D extends EndpointDefinition<any, any, any, any, infer RP> ? RP : unknown;
type TagTypesFrom<D extends EndpointDefinition<any, any, any, any>> =
	D extends EndpointDefinition<any, any, infer RP, any> ? RP : unknown;
type PageParamFrom<D extends InfiniteQueryDefinition<any, any, any, any, any>> =
	D extends InfiniteQueryDefinition<any, infer PP, any, any, any>
		? PP
		: unknown;
...
> = K extends keyof NewDefinitions
	? NewDefinitions[K]["transformResponse"] extends undefined
		...
		: UnwrapPromise<
			...
			>
	: ResultType;
type OverrideResultType<Definition, NewResultType> =
...
type PageParamFunction<DataType, PageParam> = (
	firstPage: DataType,
...
type InfiniteQuerySubState<D extends BaseEndpointDefinition<any, any, any>> =
	D extends InfiniteQueryDefinition<any, any, any, any, any>
 ...
 */
declare function fetchBaseQuery({
	baseUrl,
	prepareHeaders,
	fetchFn,
	paramsSerializer,
...
declare function fail<BaseQuery extends BaseQueryFn = BaseQueryFn>(
	error: BaseQueryError<BaseQuery>,
	meta?: BaseQueryMeta<BaseQuery>
): never;
/**
 ...
 * ```
 */
declare const retry: BaseQueryEnhancer<
	unknown,
	RetryOptions,
	void | RetryOptions
> & {
...
export {
	...
	type InfiniteQueryConfigOptions,
	type InfiniteQueryDefinition,
	type InfiniteQueryExtraOptions,
	type InfiniteQueryResultSelectorResult,
	type InfiniteQuerySubState,
	type Module,
	type MutationActionCreatorResult,
	type MutationDefinition,
	type MutationExtraOptions,
	type MutationResultSelectorResult,
	...
	type StartQueryActionCreatorOptions,
	type SubscriptionOptions,
	type Id as TSHelpersId,
	type NoInfer as TSHelpersNoInfer,
	type Override as TSHelpersOverride,
	type TagDescription,
