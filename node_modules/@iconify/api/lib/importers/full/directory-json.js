 ...
 */
export function createJSONDirectoryImporter(downloader, options = {}) {
    ...
    // Load icon set
    obj._loadIconSetFromDirectory = (prefix, path) => importIconSetFromJSON(prefix, path, '/' + prefix + '.json', options);
    return obj;
}
