 ...
 */
export const splitPackagesImporter = createJSONCollectionsListImporter(new RemoteDownloader({
    downloadType: 'npm',
    package: '@iconify/collections',
}, autoUpdate), (prefix) => createJSONPackageIconSetImporter(new RemoteDownloader({
    downloadType: 'npm',
