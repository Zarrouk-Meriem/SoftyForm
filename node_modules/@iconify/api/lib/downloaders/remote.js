 ...
 */
export class RemoteDownloader extends BaseDownloader {
    // Params
    _downloader;
    _autoUpdate;
    // Source directory
     ...
     * Constructor
     */
    constructor(downloader, autoUpdate) {
        super();
    ...
    async _init() {
        ...
        const version = await downloadRemoteArchive(downloader, lastVersion?.downloadType === downloader.downloadType ? lastVersion : void 0);
        if (version === false) {
            if (lastVersion) {
                // Keep last version
                const directory = lastVersion.contentsDir;
