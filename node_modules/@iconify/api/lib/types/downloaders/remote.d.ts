 ...
 */
export type RemoteDownloaderType = 'git' | 'github' | 'gitlab' | 'npm';
/**
 * Options
 */
...
export type RemoteDownloaderOptions = GitDownloaderOptions | GitHubDownloaderOptions | GitLabDownloaderOptions | NPMDownloaderOptions;
export type RemoteDownloaderOptionsMixin<T extends RemoteDownloaderType> = T extends 'git' ? GitDownloaderOptions : T extends 'github' ? GitHubDownloaderOptions : T extends 'gitlab' ? GitLabDownloaderOptions : T extends 'npm' ? NPMDownloaderOptions : never;
/**
...
export type RemoteDownloaderVersion = GitDownloaderVersion | GitHubDownloaderVersion | GitLabDownloaderVersion | NPMDownloaderVersion;
export type RemoteDownloaderVersionMixin<T extends RemoteDownloaderType> = T extends 'git' ? GitDownloaderVersion : T extends 'github' ? GitHubDownloaderVersion : T extends 'gitlab' ? GitLabDownloaderVersion : T extends 'npm' ? NPMDownloaderVersion : never;
export {};
