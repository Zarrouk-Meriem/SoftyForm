 ...
 */
export function prepareAPIv2IconsList(iconSet, iconsList) {
    ...
    // Categories
    if (tags.length) {
        const categories = (result.categories = Object.create(null));
    ...
    if (iconsList.chars) {
        // Add characters map
        const chars = (result.chars = Object.create(null));
