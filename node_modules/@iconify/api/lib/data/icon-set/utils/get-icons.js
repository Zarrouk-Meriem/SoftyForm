 ...
 */
export function getIconsToRetrieve(iconSet, names, copyTo) {
    const icons = new Set();
    const iconSetData = iconSet.common;
    const iconsData = iconSet.icons;
    const chars = iconsData.chars;
    const aliases = iconSetData.aliases || Object.create(null);
    function resolve(name, nested) {
 ...
 */
export function getStoredIconsData(iconSet, names, callback) {
