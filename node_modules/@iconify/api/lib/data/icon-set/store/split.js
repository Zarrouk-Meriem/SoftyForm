...
const iconDimensionProps = Object.keys(defaultIconDimensions);
const iconSetMainDataProps = [
    'prefix',
    'lastModified',
    'aliases',
    ...iconDimensionProps,
 ...
 * Get main data
 */
export function splitIconSetMainData(iconSet) {
    const result = {};
 ...
 */
export function getIconSetIconsSize(icons) {
    let length = 0;
 ...
 * Split icon set
 */
export function getIconSetSplitChunksCount(icons, config) {
