 ...
 */
export function cleanupStoredItem(storage, storedItem) {
 ...
 */
export function cleanupStorage(storage) {
 ...
 */
export function addStorageToCleanup(storage, storedItem) {
    if (!storedItem.data) {
        // Nothing to watch
        return;
    }
