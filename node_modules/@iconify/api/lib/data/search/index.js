 ...
 * Run search
 */
export function search(params, data, iconSets) {
    // Get keywords
    ...
    // Prepare variables
    const addedIcons = Object.create(null);
    const allMatches = [];
    let allMatchesLength = 0;
    const getMatchResult = (length, partial) => {
    ...
    const runSearch = (search, isExact, partial) => {
