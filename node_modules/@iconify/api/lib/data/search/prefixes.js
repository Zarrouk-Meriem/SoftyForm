 ...
 */
export function filterSearchPrefixesList(prefixes, filters) {
 ...
 * Filter prefixes
 */
export function filterSearchPrefixes(data, iconSets, params) {
    let prefixes;
    // Filter by palette
    ...
    if (category) {
        prefixes = (prefixes || data.sortedPrefixes).filter((prefix) => iconSets[prefix].item.info?.category === category);
    }
    // Filter by tag
